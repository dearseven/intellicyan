package cyan.intellicyan.components.calendarview;
...
public class RecyclerViewCalenar extends RecyclerView.Adapter<RecyclerViewCalenar.CalendarItem> implements View.OnClickListener {
    ...
    public RecyclerViewCalenar(Parent parent, int recyclerViewId, int lastId, int nextId, int showId) {
        ...
        this.rv.setLayoutManager(new GridLayoutManager(parent.getParentContext(), 7));
        this.rv.addItemDecoration(new DividerGridItemDecoration(parent.getParentContext()));
    ...
    public void onBindViewHolder(CalendarItem holder, int position) {
        ...
        int itemW = parent.getParentContext().getResources().getDisplayMetrics().widthPixels / 7;
        int itemH = itemW;
